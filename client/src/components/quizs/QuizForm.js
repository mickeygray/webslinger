...
const QuizForm = ({ setForm }) => {
 ...
 const onSubmit = async (e) => {
  ...
  formData.append("launchCopy", launchCopy);
   ...
   <form onSubmit={onSubmit}>
    <div className='card bg-light grid-2'>
     <div>
      ...
      <input type='text' onChange={onChange} name='author' value={author} />
      ...
      <select value={type} onChange={onChange} name='type'>
       ...
       <option value='relative'>
        Relative: The Score Value ONLY influences which question the user sees
        next
       </option>
       <option value='joint'>
        Joint: The Score Value WILL INFLUENCE both the result and which question
        the user sees next.
       </option>
      </select>
      <label htmlFor='name'>Ad Preference</label>
      <select value={adPreference} onChange={onChange} name='adPreference'>
       <option></option>
       <option value='firm'>
        If Associated With A Firm Will Display Clickable Ad For Your Firm
       </option>
       <option value='vertical'>
        If Associated With A Vertical Will Display Clickable Ad For All Firms In
        Vertical
       </option>
       <option value='info'>
     ...
     <div>
      ...
      <input
       type='text'
       name='launchCopy'
       placeholder='On The Start Button '
       value={launchCopy}
       onChange={onChange}
      />
     </div>
       ...
       <div className='card bg-light' key={index}>
        ...
        <div>
         ...
         <select
          ...
          <option value='video'>
           Video: Question Will Present As YouTube Video Followed By Multiple
           Choice (one per page)
          </option>
         </select>
         ...
         <select
          ...
          <option value='true'>Collect This Information As Lead Data</option>
         </select>
         ...
         {result.isLeadCapture === "true" ? (
          <div className=''>
           ...
           <select
            ...
            <option value='residents'>Persons Residing In The Home</option>
           </select>
          </div>
         ) : (
          ""
        ...
        <br />
        <i>
         If you are doing a relative or joint quiz please ensure your answer
         totals match an existing question page.
        </i>
        <div className='grid-2'>
         {result.answers
